...
Game.where(name: "my_first_game").first.cards.create([
	{name: "Amauris", avatar: File.new("/images/1.jpg")},
	{name: "Donovan", avatar: File.new("/images/2.jpg")},
	{name: "Chris", avatar: File.new("/images/3.jpg")},
	{name: "Jerry", avatar: File.new("/images/4.jpg")},
	{name: "Kim", avatar: File.new("/images/5.jpg")},
	{name: "Ohad", avatar: File.new("/images/6.jpg")},
	{name: "Quinn", avatar: File.new("/images/7.jpg")},
	{name: "Kirsten", avatar: File.new("/images/8.jpg")},
	{name: "Alex", avatar: File.new("/images/9.jpg")},
	{name: "Mandisa", avatar: File.new("/images/10.jpg")},
	{name: "Juan", avatar: File.new("/images/11.jpg")},
	{name: "Kassim", avatar: File.new("/images/12.jpg")},
	{name: "Jay", avatar: File.new("/images/13.jpg")},
	{name: "Rick", avatar: File.new("/images/14.jpg")},
	{name: "Bill", avatar: File.new("/images/15.jpg")},
	{name: "Matt E", avatar: File.new("/images/16.jpg")},
	{name: "Sanja", avatar: File.new("/images/17.jpg")},
	{name: "Matt S", avatar: File.new("/images/18.jpg")},
	{name: "Amzad", avatar: File.new("/images/19.jpg")},
	{name: "Greg", avatar: File.new("/images/20.jpg")},
	{name: "Sam", avatar: File.new("/images/21.jpg")},
	{name: "Liana", avatar: File.new("/images/22.jpg")},
	{name: "Andy", avatar: File.new("/images/23.jpg")},
	{name: "Niall", avatar: File.new("/images/24.jpg")}])
